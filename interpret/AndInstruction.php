 ...
 * Perform logical AND operation on two boolean values and store the result in the specified variable
 */
class AndInstruction extends Instruction {
    ...
    public function execute(Interpret $interpret): void {
        ...
        $this->set_value($this->arguments[0]->get_value(), ($src_value_1 === "true" && $src_value_2 === "true") ? "true" : "false", $this->arguments[0]->get_frame(), $interpret);
