 ...
 * Concatenate two string values and store the result in the specified variable
 */
    ...
    // Execute the instruction
     public function execute(Interpret $interpret): void {
        ...
        if ((isset($this->arguments[0])) && (isset($this->arguments[1])) && (isset($this->arguments[2]))) {
            ...
            // Validate the types
            if (($src_type_1 !== "string") || ($src_type_2 !== "string") || (!$this->valid_types($src_type_1, $src_value_1)) || (!$this->valid_types($src_type_2, $src_value_2)))
                throw new OperandTypeException();
    
            // Set the <var> value and type
            $this->set_value($this->arguments[0]->get_value(), $src_value_1 . $src_value_2, $this->arguments[0]->get_frame(), $interpret);
