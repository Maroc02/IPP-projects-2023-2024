 ...
 * Substract two integer values and store the result in the specified variable
 */
class SubInstruction extends Instruction {
    ...
    public function execute(Interpret $interpret): void {
        ...
        $this->set_value($this->arguments[0]->get_value(), intval($src_value_1) - intval($src_value_2), $this->arguments[0]->get_frame(), $interpret);
